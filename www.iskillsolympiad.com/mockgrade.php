...
<?php include('include/common.php'); ?>
	...
	<body>
		<!--<header>
			<p class="text-center">
				Welcome <?php if(empty($_SESSION['name'])){echo $_SESSION['Student_Name'];}?>
			</p>
		</header>-->
        <?php if(empty($_SESSION['name'])){echo $_SESSION[''];}?>
			...
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-3">
					<div class="intro">
						...
						<form class="form-signin" method="post" id='signin' name="signin" action="mocktest.php">
							<div class="form-group">
							<input type="text" id='name' name='name' class="form-control" placeholder="Enter your Name" value="<?php echo $_SESSION['Student_Name']; ?>" readonly/>
								<span class="help-block"></span>
							</div>
							<div class="form-group">
							    <select class="form-control" name="category" id="category">
                                <option value="<?php echo $_SESSION["group_id"]; ?>" readonly>Group-<?php echo $_SESSION["group_id"]; ?></option>
